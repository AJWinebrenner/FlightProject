...
public class Flight{
    ...
    public Flight(String flightCode, Destination destination, LocalDateTime departureTime, String[] passengerIds) {
        this.flightCode = flightCode;
        this.destination = destination;
        this.departureTime = departureTime;
        this.maxCapacity = passengerIds.length;
    ...
    public String toStringCSV() {
        return flightCode + "," + destination + "," + departureTime.getYear() + "-" + departureTime.getMonthValue() + "-" + departureTime.getDayOfMonth() + "-" + departureTime.getHour() + "-" + departureTime.getMinute() + "," + Arrays.toString(passengerIds);
    }
